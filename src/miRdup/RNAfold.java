...
public class RNAfold {
     ...
     */
     public static String GetSecondaryStructureTmp(String sequence) {
        if (Main.debug) System.out.println("Getting secondary structure of sequence "+sequence);
        String struct="";
        String output="";
        String mfe="";
     ...
     */
     public static File GetSecondaryStructuresFromFile(File infile) {
        if (Main.debug) System.out.println("Getting secondary structure of file "+infile);

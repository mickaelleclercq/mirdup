...
=====REQUIRED SOFTWARES=====
- Weka 3.6 (already in lib folder, or you can dowload if from http://www.cs.waikato.ac.nz/~ml/weka/)
...
To run miRdup, you must give the path of Vienna package programs (/[your_path]/ViennaRNA-2.0.7/Progs/) with -r option.
...
- To train a model on all miRbase sequences, use this command: 
	Linux/Mac:	java -jar miRdup.jar -r /home/user/my_user/ViennaRNA-2.0.7/Progs/
	Windows:	java -jar miRdup.jar 
